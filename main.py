...
PAYMENT_CHANNEL = "@EarnFreeCryptocurrency_Payment" #add payment channel here including the '@' sign
OWNER_ID = 5891641055 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@EarnFreeCryptocurrency_Payment"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
   ...
   try:
    ...
    if msg == '/start':
        ...
        markups.add(telebot.types.InlineKeyboardButton(
            text='🤼‍♂️ Joined', callback_data='check'))
        msg_start = "*To Use This Bot You Need To Join This Channel👇 - \n➡️ @Earn_Free_Cryptocurrency_Trx*"
        bot.send_message(user, msg_start,
